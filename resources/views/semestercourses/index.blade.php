    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div >
            ...
            <td>{{$course->plan_year}}</td>
            <td>{{$course->semester_type}}</td>
            <td>
                <a href="{{ route('semestercourses.edit',$course->row_id)}}" class="btn btn-success">Add</a>
            </td>
        ...
        <div >
            ...
            <td>
                    ...
                    <a href="offeredcourses/{{$course->semester_course_id}}/destroy" class="btn btn-danger" type="submit">Delete</a>
            </td>
