    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <form method="post" action="{{ route('courses.store') }}">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <label for="offered_by_faculty">Offered by Faculty</label>
                <input type="text" class="form-control" name="offered_by_faculty" >
            </div>
            
            <div class="form-group">
                <label for="degree_year_plan_id">Degree Year ID</label>
                <input type="text" class="form-control" name="degree_year_plan_id"  >
            </div>
            <div class="form-group">
