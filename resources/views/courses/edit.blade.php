...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <br /> 
        @endif
        <form method="post" action="{{ route('courses.update', $course->row_id) }}">
...
<label for="offered_by_faculty">Faculty</label>
<input type="text" class="form-control" name="offered_by_faculty" value={{ $course->offered_by_faculty }} >
</div>
